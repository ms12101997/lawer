			...
			<div class="main-sidemenu">
				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						@can(' رسائل الاستفسار')
						<ul class="slide-menu">
								<li><a class="slide-item" href="{{ url('/admin/' . ($page = 'discuss')) }}"> رسائل الاستفسار</a></li>	
						</ul>
						@endcan
					</li>
					@endcan
					...
					<li class="slide">
						...
						<ul class="slide-menu">
								...
								@can('قائمة المستخدم')
								<li><a class="slide-item" href="{{ url('/admin/' . ($page = 'users')) }}">قائمة المستخدم</a></li>
								@endcan
								@can('صلاحية المستخدمين')
								<li><a class="slide-item" href="{{ url('/admin/' . ($page = 'roles')) }}"> صلاحيات المستخدم</a></li>
								@endcan
						</ul>
					</li>
					@endcan
					...
					<li class="slide">
						...
						<ul class="slide-menu">
								@can('اضافة سليدر')
								<li><a class="slide-item" href="{{ url('/admin/' . ($page = 'slider')) }}">إضافة سليدر </a></li>
								@endcan
								@can('تواصل معنا ')
								<li><a class="slide-item" href="{{ url('/admin/' . ($page = 'contact')) }}">تواصل معنا</a></li>
								@endcan
								@can(' لماذا تختار محامينا')
								<li><a class="slide-item" href="{{ url('/admin/' . ($page = 'lawer')) }}"> لماذا تختار محامينا</a></li>
								@endcan
								@can('من نحن ')
								<li><a class="slide-item" href="{{ url('/admin/' . ($page = 'who')) }}"> من نحن</a></li>
								@endcan
								@can('مرحبا بكم')
